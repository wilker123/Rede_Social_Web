   ...
   <i class="fas fa-photo-video"></i><a style="color:white" href="{{url('/home')}}">Feed</a>
    ...
    <div class="fundo">
        ...
        <center class="contend-middle">
            ...
            <div class="feedback" style="margin-left:220px">
                <div class="input-group mb-3">
                    ...
                    <form name="gostei">
                            ...
                            @if(isset($like))
                                <button type="submit" class="input-group-text" name="like" id="curtir">deslike<i
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <p style="padding:5opx">
                            ...
                            <img width="50vh" ; class="rounded-circle" src="{{url('storage/users/'.$coment->perfil)}}">
